...
// ExtractClaudeCodeSessionID resolves a Claude Code session ID, preferring
// X-Claude-Code-Session-Id over payload metadata.
...
// used by Codex prompt-cache and reasoning-replay state.
...
// ClaudeCodePromptCache derives a deterministic upstream prompt_cache_key for
// one Claude Code agent execution scope.
