...
func TestNormalizeCodexParallelToolCallsForTools_RemovesWhenToolsMissing(t *testing.T) {
...
func TestNormalizeCodexParallelToolCallsForTools_RemovesWhenToolsEmpty(t *testing.T) {
	body := []byte(`{"model":"gpt-5.4","tools":[],"parallel_tool_calls":true,"input":"hi"}`)
