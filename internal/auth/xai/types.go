...
const (
	...
	// Used for websocket, media (image/video), non-OAuth credentials, and
	// non-media HTTP chat when auth using_api is true.
	...
	// OAuth credential files persist this as base_url by default.
