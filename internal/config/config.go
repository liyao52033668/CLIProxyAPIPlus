...
type Config struct {
	...
	// gemini-cli, vertex, aistudio, antigravity, claude, codex, iflow, kiro, github-copilot, kimi, codearts, joycode, gitlab, cursor, qoder, codebuddy, codebuddy-ai, kilo, bt.
	//
