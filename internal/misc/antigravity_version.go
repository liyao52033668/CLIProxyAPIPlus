...
var (
	...
	antigravityFetchTimeout         = defaultAntigravityFetchTimeout
)

// SetAntigravityFetchTimeout overrides the HTTP timeout used when refreshing the Antigravity version.
