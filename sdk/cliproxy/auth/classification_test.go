...
func TestAccountInfoUsesExplicitAuthKind(t *testing.T) {
	...
	oauthWithoutEmail := &Auth{Attributes: map[string]string{AttributeAuthKind: AuthKindOAuth, AttributeAPIKey: "k"}}
